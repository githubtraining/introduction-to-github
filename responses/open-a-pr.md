...
1. From the "Code" tab, click **New pull request**
1. In the "base:" drop-down menu, make sure the "master" branch is selected
1. In the "compare:" drop-down menu, select "{{ branch }}"
1. When you’ve selected your branch, enter a title for your pull request, for example `Add {{ username }}'s file`
